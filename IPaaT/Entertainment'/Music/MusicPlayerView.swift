...
struct MusicPlayerView: View {
    ...
    @State var songs = ["Melody of Nature by GoodBMusic", "Sweden by C418", "Oogway Ascends (slowed) by Hans Zimmer", "Wii Sports Theme - Epic Orchestral Remix", "Joy of Travel by GoodBMusic","Cali by Wataboi"]
    @State var current = 0
    ...
    var body: some View {
        VStack(spacing: 20){
            ...
            Text("Up next: \(songs[self.current+1])")
                .padding(.top, 45)
        }
        .padding()
        .onAppear{
